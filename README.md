...
| 32 | [Arta-Omran-Varaq](https://github.com/Sobhan-SRZA/Arta-Omran-Varaq) | `وبسایت رسمی شرکت آرتا عمران ورق اردبیل - شرکت سوله سازی` | **✅ Done** | **🔒 Private** | ![Used HTML](images/html.svg) ![Used CSS](images/css.svg) ![Used JavaScript](images/javascript.svg) | `none` | `none` | `none` |
