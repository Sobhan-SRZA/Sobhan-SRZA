...
| 34 | [Online-Shop](https://github.com/Sobhan-SRZA/Online-Shop) | `A full-stack e-commerce web application, This project demonstrates modern web development practices, including RESTful API design, TypeScript integration, and database management with Prisma and SQLite. It includes core e-commerce features such as product management, user authentication, and a shopping cart.` | **✅ Done** | **🌐 Public** | ![Used HTML](images/html.svg) ![Used JavaScript](images/javascript.svg) ![Used TypeScript](images/typescript.svg) ![Used CSS](images/css.svg) | ![Used Node.js](images/node.js.svg) ![Used NPM](images/npm.svg) | ![Stars](https://img.shields.io/github/stars/Sobhan-SRZA/Online-Shop?style=flat-square) | ![Forks](https://img.shields.io/github/forks/Sobhan-SRZA/Online-Shop?style=flat-square) |
